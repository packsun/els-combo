...
function skillInfo(event) {
	...
	var id = this.id;
	var thisAction = bladeMaster[id];
	$('#skillName').text(thisAction['Name']);
	$('#skillDMG').text(thisAction['DMG'] + '%');
	$('#skillMP').text(thisAction['MP']);
	$('#skillKD').text(thisAction['KD']);
...
bladeMaster = {
	...
	'up': {'Name': 'Jump', 'KD': 0, 'MP': 0, 'DMG': 0, 'MP2': 0,
	...
	'left2': {'Name': 'Back dash', 'KD': 0, 'MP': 0, 'DMG': 0, 'MP2': 0,
		'img': imgButton + 'left2 src=/images/left2.png>',
		'img2': ' <img src=/images/left2.png>',
		'next': {'basic': ['Z0', 'X0', 'right20', 'up0', 'right', 'left0', 'down0', 'left20'],
		'active': noActives, 'special': noSpecials}
	},
	'right2': {'Name': 'Front dash', 'KD': 0, 'MP': 0, 'DMG': 0, 'MP2': 0,
	...
	'ZZZ': {'Name': 'ZZZ', 'KD': 15, 'MP': 7, 'DMG': 150, 'MP2': 6,
	...
	'ZZZZ': {'Name': 'ZZZZ', 'KD': -30, 'MP': 7, 'DMG': 200, 'MP2': 6,
		'img': imgButton + 'ZZZZ src=/images/Z.png>',
		'img2': '<img src=/images/Z.png>',
		'next': {'basic': noBasic, 'active': noActives, 'special': noSpecials}
	},
	'ZZZUZ': {'Name': 'ZZZ^Z', 'KD': 15, 'MP': 7, 'DMG': 150, 'MP2': 6,
	...
	// ACTIVE SKILLS
	'5L': {'Name': 'Breaking Fist', 'KD': 0, 'MP': -20, 'DMG': 369, 'MP2': 6, 'CD': 4,
	...
	'5R': {'Name': 'Burning Rush', 'KD': 0, 'MP': -7, 'DMG': 402, 'MP2': 6, 'CD': 8,
	...
	'10R': {'Name': 'Ground Impact', 'KD': 0, 'MP': -20, 'DMG': 369, 'MP2': 6, 'CD': 4,
	...
	'25': {'Name': 'Mega Drill Break', 'KD': 0, 'MP': -45, 'DMG': 400, 'MP2': 6, 'CD': 6,
	...
	'40RR': {'Name': 'Shadow Pierce', 'KD': 0, 'MP': -15, 'DMG': 459, 'MP2': 6, 'CD': 5,
	...
	'45L': {'Name': 'Finishing Slash', 'KD': 0, 'MP': -28, 'DMG': 475, 'MP2': 36, 'CD': 6,
	...
	'45R': {'Name': 'Sonic Slash', 'KD': 0, 'MP': -35, 'DMG': 413, 'MP2': 52, 'CD': 6,
	...
	'60L': {'Name': 'Shadow Thrust', 'KD': 0, 'MP': -25, 'DMG': 527, 'MP2': 6, 'CD': 5,
	...
	'0': {'Name': 'Power Assault', 'KD': 0, 'MP': -120, 'DMG': 1444, 'MP2': 30, 'CD': 8,
		'img': imgButton + '0 src=/images/BM/0.png>',
		'img2': ' ' + img + '0-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'10L': {'Name': 'Earth Break', 'KD': 0, 'MP': -85, 'DMG': 994, 'MP2': 12, 'CD': 7,
	...
	'15R': {'Name': 'Maximum Cannon', 'KD': 0, 'MP': -65, 'DMG': 677, 'MP2': 24, 'CD': 5,
	...
	'20L': {'Name': 'Cannon Blade', 'KD': 0, 'MP': -180, 'DMG': 4166, 'MP2': 66,
		'img': imgButton + '20L src=/images/BM/20L.png>',
		'img2': ' ' + img + '20L-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'20R': {'Name': 'Seven Burst', 'KD': 0, 'MP': -260, 'DMG': 3307, 'MP2': 60,
		'img': imgButton + '20R src=/images/BM/20R.png>',
		'img2': ' ' + img + '20R-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'15': {'Name': 'Berserker Blade', 'KD': 0, 'MP': -102, 'DMG': 1600, 'MP2': 18,
		'img': imgButton + '15 src=/images/BM/15.png>',
		'img2': ' ' + img + '15-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'30L': {'Name': 'Shockwave - Divider', 'KD': 0, 'MP': -170, 'DMG': 2412, 'MP2': 72,
	...
	'30R': {'Name': 'Shockwave - Cutter', 'KD': 0, 'MP': -170, 'DMG': 2010, 'MP2': 60, 'CD': 10,
		'img': imgButton + '30R src=/images/BM/30R.png>',
		'img2': ' ' + img + '30R-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'35': {'Name': 'Wolf Fang', 'KD': 0, 'MP': -90, 'DMG': 1218, 'MP2': 18, 'CD': 10,
	...
	'40L': {'Name': 'Hypersonic Stab', 'KD': 0, 'MP': -270, 'DMG': 2330, 'MP2': 6, 'CD': 23,
		'img': imgButton + '40L src=/images/BM/40L.png>',
		'img2': ' ' + img + '40L-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'40R': {'Name': 'Bloody Accel', 'KD': 0, 'MP': -275, 'DMG': 1852, 'MP2': 6, 'CD': 32, 
		'img': imgButton + '40R src=/images/BM/40R.png>',
		'img2': ' ' + img + '40R-2.png>',
		'next': {'basic': allBasic, 'active': allActives,
		'special': noSpecials}
	},
	'50RR': {'Name': 'Flying Impact', 'KD': 0, 'MP': -170, 'DMG': 2714, 'MP2': 84, 'CD': 11,
		'img': imgButton + '50RR src=/images/BM/50RR.png>',
		'img2': ' ' + img + '50RR-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'55L': {'Name': 'Giga Drive - Limiter', 'KD': 0, 'MP': -180, 'DMG': 1536, 'MP2': 6, 'CD': 20, 
	...
	'55R': {'Name': 'Giga Drive - Seismic Tremor', 'KD': 0, 'MP': -170, 'DMG': 3420, 'MP2': 48,
		'img': imgButton + '55R src=/images/BM/55R.png>',
		'img2': ' ' + img + '55R-2.png>',
		'next': {'basic': noBasic, 'active': noActives,
		'special': noSpecials}
	},
	'65': {'Name': 'Extreme Blade', 'KD': 0, 'MP': -300, 'DMG': 5283, 'MP2': 120,
